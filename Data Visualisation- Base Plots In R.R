...
boxplot(mtcars$mpg, col='green')  #colour=col
...
Y=11:20
plot(x=X, y=Y)
plot(x=X, y=Y, type='s') #points s=steps
plot(x=X, y=Y, type='p', pch=11) #points, plotting symbol=13 pch has variety of values which gives variety of symbols
...
corrplot(z, type = "upper", 
         tl.col = "black", tl.srt = 45)  #srt=angle
