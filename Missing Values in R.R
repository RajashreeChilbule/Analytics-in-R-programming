...
# is.na() - indicates which elements are missing as TRUE
is.na(df) 
...
df_titanic <- read.csv(file="C:/Users/Raj/Documents/R/Matrix Data structure/data/TitanicDataMissingValues.csv")
View(df_titanic)
dim(df_titanic)
